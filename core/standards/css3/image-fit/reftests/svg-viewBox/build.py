...
<body>
<div id="test">
 <svg xmlns="http://www.w3.org/2000/svg" width="220" height="220" viewBox="0 0 440 440" preserveAspectRatio="%s">
...
for pAR in pARs:
	...
	for fit in fits:
		...
		# Adjust ref dimensions by half because the viewbox is four times the size of the shape.
		if fit == 'auto':
			refx = 200/2 - refw;
			refy = 100/2 - refh;
			shapew = refw
		...
		test_file.close()
		refstyle = 'left:%spx; top:%spx; width:%spx; height:%spx' % (refx, refy, shapew, shapeh)
