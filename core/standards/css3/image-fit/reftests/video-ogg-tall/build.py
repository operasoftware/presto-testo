...
<div id="ref">
 <span class="helper"><img src="../../support/%s.png"></span>
</div>
"""

reftest_list = ''
ref_hashes = {}
for overflow,fit,x,y in allpairs_v.tests:
    refx = refy = ''
    testx = x
    testy = y
