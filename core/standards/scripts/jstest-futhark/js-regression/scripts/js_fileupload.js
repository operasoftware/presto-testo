...
function main( fileuploadObject )
{
   try
   {
      var cvs = "$Id: js_fileupload.js 22548 2008-01-23 21:29:12Z hallvord $";
      testmodule( "The FileUpload object", cvs );
      testcase('File upload element object');
...
function testFileUploadProperties( file )
{
   ...
   test( "value", file.value, "" );

   file.value = "New FileUpload value";
   file.name = "afile";
   file.type = "text";

   test( "modified value", file.value, "", "feature not implemented for security reasons" );
