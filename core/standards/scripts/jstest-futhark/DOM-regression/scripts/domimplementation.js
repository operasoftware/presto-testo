...
var cvs = "$Id: domimplementation.js 22424 2008-01-18 14:04:59Z hallvord $";
...
try {
  ...
  test("hasFeature StyleSheets 2.0", document.implementation.hasFeature("StyleSheets", "2.0"), 'styleSheets' in document);
  test("hasFeature CSS 2.0", document.implementation.hasFeature("CSS", "2.0"), true);
  test("hasFeature CSS2 2.0", document.implementation.hasFeature("CSS2", "2.0"), true);
