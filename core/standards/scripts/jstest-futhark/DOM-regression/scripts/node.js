...
var cvs = "$Id: node.js 125272 2012-10-17 08:09:05Z svn $";
...
testcase( "Read-only attributes" );
  ...
  try {
      ...
      test( "childNodes - callable 1", w(0), the_link );
      test( "childNodes - callable 2", w(1), the_span );
    }
    catch (e) {
  ...
  tdef( "childNodes #8", w );
  test( "childNodes #9", w.length, 1 ); // fixed after changed implementation May 09 - Hallvord

  w = the_span.childNodes;
  tdef( "childNodes #10", w );
  test( "childNodes #11", w.length, 1 );
  var the_text = w.item(0);
  tdef( "r/o attributes #7", the_text );
  test( "parentNode #7", the_text.parentNode, the_span );
  expect_DOM_exception( "parentNode #8", DOMException.NO_MODIFICATION_ALLOWED_ERR,
  ...
  tdef( "firstChild #4", the_attr.firstChild );// fixed after changed implementation May 09 - Hallvord
  ...
  tdef( "lastChild #4", the_attr.lastChild );// fixed after changed implementation May 09 - Hallvord
  ...
  test( "attributes #2", the_nodemap.length, 2 );
  ...
  test( "attributes #9", the_nodemap.item(2), null ); // support for default attributes dropped
...
//  test( "attributes #11", the_nodemap.item(2).value, "rect" );
  expect_DOM_exception( "attributes #9A", DOMException.NO_MODIFICATION_ALLOWED_ERR,
  ...
  test( "namespaceURI #1", the_link.namespaceURI, "http://www.w3.org/1999/xhtml" );
  expect_DOM_exception( "namespaceURI #2", DOMException.NO_MODIFICATION_ALLOWED_ERR,
	                function(){ the_link.namespaceURI=null; } );

  test( "localName #1", the_link.localName.toUpperCase(), "A" );
  test( "localName #2", the_span.localName.toUpperCase(), "SPAN" );
  test( "localName #3", the_div.localName.toUpperCase(), "DIV" );
  test( "localName #4", the_body.localName.toUpperCase(), "BODY" );
...
testcase( "appendChild" );
  ...
  test( "appendChild #3", the_frag.lastChild.localName.toUpperCase(), "SPAN" );
  ...
  test( "appendChild #8", the_div.lastChild.localName.toUpperCase(), "SPAN" );
  ...
  test( "appendChild #25", the_link.localName.toUpperCase(), "A" );
  ...
  test( "appendChild #43", the_span.localName.toUpperCase(), "SPAN" );

  // null test
  expect_DOM_exception(  "appendChild with null argument", DOMException.NO_DATA_ALLOWED_ERR, function(){ the_child = the_div.appendChild( null );} );

  // test of wrong input parameters
  expect_DOM_exception(  "appendChild with string argument", DOMException.NO_DATA_ALLOWED_ERR, function(){ the_div.appendChild( "test" );} );
  expect_DOM_exception(  "appendChild with number argument", DOMException.NO_DATA_ALLOWED_ERR, function(){ the_div.appendChild( 1 );} );
  expect_DOM_exception(  "appendChild with no argument", DOMException.NO_DATA_ALLOWED_ERR, function(){ the_div.appendChild();} );
...
testcase( "cloneNode" );
  ...
  test( "cloneNode #7", clone2.localName.toUpperCase(), "A" );

  var clone3 = the_span.cloneNode( true );

  tdef( "cloneNode #8", clone3 );
  test( "cloneNode #9", clone3.localName.toUpperCase(), "SPAN" );
  ...
  test( "cloneNode #24", clone2.localName.toUpperCase(), "A" );

  tdef( "cloneNode #25", clone3 );
  test( "cloneNode #26", clone3.localName.toUpperCase(), "SPAN" );
  ...
  test( "cloneNode #41", the_clone.localName.toUpperCase(), "HREF" );
  ...
  test( "cloneNode #48", w.item(0).localName.toUpperCase(), "A" );
  test( "cloneNode #49", w.item(1).localName.toUpperCase(), "SPAN" );

  // test of wrong input parameters
  expect_DOM_exception(  "cloneNode with no argument", DOMException.NO_DATA_ALLOWED_ERR, function(){the_div.cloneNode();} );
...
testcase( "hasAttributes" );
  ...
  test( "hasAttributes #11", the_div.hasAttributes(), true );
  the_nodemap = the_div.attributes;
  tdef( "hasAttributes #12", the_nodemap );
  test( "hasAttributes #13", the_nodemap, "[object NamedNodeMap]" );
  test( "hasAttributes #14", the_nodemap.length, 1 );
  test( "hasAttributes #15", the_nodemap.item(0).nodeType, Node.ATTRIBUTE_NODE );
  test( "hasAttributes #16", the_nodemap.item(0).name, "id" );
  test( "hasAttributes #17", the_nodemap.item(0).value, "div-foo" );

  test( "hasAttributes #18", the_link.hasAttributes(), true );

  test( "hasAttributes #19", the_span.hasAttributes(), true );
  the_nodemap = the_span.attributes;
  tdef( "hasAttributes #20", the_nodemap );
  test( "hasAttributes #21", the_nodemap, "[object NamedNodeMap]" );
  test( "hasAttributes #22", the_nodemap.length, 1 );
  test( "hasAttributes #23", the_nodemap.item(0).nodeType, Node.ATTRIBUTE_NODE );
  test( "hasAttributes #24", the_nodemap.item(0).name, "id" );
  test( "hasAttributes #25", the_nodemap.item(0).value, "span-foo" );

  test( "hasAttributes #26", the_attr.hasAttributes(), false );

  test( "hasAttributes #27", the_frag.hasAttributes(), false );

  test( "hasAttributes #28", the_text.hasAttributes(), false );
...
testcase( "hasChildNodes" );
  ...
  test( "hasChildNodes #12", the_attr.hasChildNodes(), true );
...
testcase( "insertBefore" );
  ...
  test( "insertBefore #3", the_clone.firstChild.localName.toUpperCase(), "A" );
  test( "insertBefore #4", the_clone.lastChild.localName.toUpperCase(), "SPAN" );
  ...
  test( "insertBefore #7", the_clone.firstChild.localName.toUpperCase(), "SPAN" );
  test( "insertBefore #8", the_clone.lastChild.localName.toUpperCase(), "A" );
  ...
  test( "insertBefore #18", the_frag.childNodes.item(0).localName.toUpperCase(), "A" );
  test( "insertBefore #19", the_frag.childNodes.item(1).localName.toUpperCase(), "SPAN" );
  test( "insertBefore #20", the_frag.childNodes.item(2).localName.toUpperCase(), "A" );
  test( "insertBefore #21", the_frag.childNodes.item(3).localName.toUpperCase(), "SPAN" );
  ...
  test( "insertBefore #38", the_div.firstChild.localName.toUpperCase(), "A" );
  test( "insertBefore #39", the_div.lastChild.localName.toUpperCase(), "SPAN" );
  ...
  test( "insertBefore #42", the_div.firstChild.localName.toUpperCase(), "SPAN" );
  test( "insertBefore #43", the_div.lastChild.localName.toUpperCase(), "A" );
  ...
  test( "insertBefore #48", tmp.localName.toUpperCase(), "A" );
  ...
  test( "insertBefore #54", the_div.childNodes.item(0).localName.toUpperCase(), "A" );
  test( "insertBefore #55", the_div.childNodes.item(0).hasChildNodes(), false );
  test( "insertBefore #56", the_div.childNodes.item(1).localName.toUpperCase(), "A" );
  test( "insertBefore #57", the_div.childNodes.item(1).hasChildNodes(), false );
  test( "insertBefore #58", the_div.childNodes.item(2).localName.toUpperCase(), "SPAN" );
  ...
  test( "insertBefore #61", the_div.childNodes.item(3).localName.toUpperCase(), "A" );
  test( "insertBefore #62", the_div.childNodes.item(3).hasChildNodes(), false );
  test( "insertBefore #63", the_div.childNodes.item(4).localName.toUpperCase(), "SPAN" );
  ...
  test( "insertBefore #66", the_div.childNodes.item(5).localName.toUpperCase(), "SPAN" );
  ...
  expect_DOM_exception( "insertBefore #69", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){   the_div.insertBefore( the_frag.lastChild, the_div.lastChild ); } );
    expect_DOM_exception( "insertBefore #70", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){the_frag.insertBefore( the_frag.firstChild, the_frag.lastChild ); } );

  // test of wrong input parameters
    expect_DOM_exception( "insertBefore #71", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){the_div.insertBefore( "test" ,1 ); } );
    expect_DOM_exception( "insertBefore #72", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){the_div.insertBefore( the_clone ); } );

  // exception tests
  expect_DOM_exception( "insertBefore #73", undefined,
	                  function(){ the_frag.firstChild.insertBefore( the_frag.lastChild, the_div.lastChild ); } );

  expect_DOM_exception( "insertBefore #74", DOMException.HIERARCHY_REQUEST_ERR,
	                  function(){ the_div.firstChild.insertBefore( the_div, the_div.lastChild ); } );

  expect_DOM_exception( "insertBefore #75", DOMException.NOT_FOUND_ERR,
  ...
  tdef( "insertBefore #76", the_clone.childNodes );
  test( "insertBefore #77", the_clone.childNodes.length, 6 );
  test( "insertBefore #78", the_clone.nodeType, Node.ELEMENT_NODE );
  tdef( "insertBefore #79", the_frag );
  test( "insertBefore #80", the_frag.nodeType, Node.DOCUMENT_FRAGMENT_NODE );
  test( "insertBefore #81", the_frag.hasChildNodes(), false );
  test( "insertBefore #82", the_frag.lastChild, null );
  tmp = the_frag.insertBefore( the_clone.lastChild, the_frag.lastChild );
  tmp = the_frag.insertBefore( the_clone.lastChild, null );
  tdef( "insertBefore #83", the_frag.childNodes );
  test( "insertBefore #84", the_frag.childNodes.length, 2 );
  ...
  expect_DOM_exception( "insertBefore #86", DOMException.NOT_FOUND_ERR,
  ...
  expect_DOM_exception( "insertBefore #88", DOMException.NOT_FOUND_ERR,
	                  function(){ the_div.insertBefore( the_frag.firstChild, the_frag ); } );

  expect_DOM_exception( "insertBefore #89", DOMException.HIERARCHY_REQUEST_ERR,
				function(){ the_div.insertBefore( the_span.attributes.item(0), the_div.attributes.item(0) ); } );

  expect_DOM_exception( "insertBefore #90", DOMException.HIERARCHY_REQUEST_ERR,
				function(){ the_div.insertBefore( the_span.attributes.item(0), null ); } );

  expect_DOM_exception( "insertBefore #91", DOMException.NOT_FOUND_ERR,
				function(){ the_div.insertBefore( the_span, the_div.attributes.item(0) ); } );

  expect_DOM_exception( "insertBefore #92", DOMException.HIERARCHY_REQUEST_ERR,
...
testcase( "removeChild" );
  ...
  test( "removeChild #2", the_div.childNodes.item(0).localName.toUpperCase(), "A" );
  test( "removeChild #3", the_div.firstChild.hasChildNodes(), false );
  test( "removeChild #4", the_div.childNodes.item(1).localName.toUpperCase(), "SPAN" );
  ...
  test( "removeChild #8", tmp.localName.toUpperCase(), "SPAN" );
  ...
  // null test
  expect_DOM_exception( "removeChild #14", DOMException.NO_DATA_ALLOWED_ERR,
				function(){ tmp = the_div.removeChild( null );} );

  // test of wrong input parameters
  expect_DOM_exception( "removeChild #15", DOMException.NO_DATA_ALLOWED_ERR,
				function(){ the_div.removeChild( "test" ,1 );} );
  expect_DOM_exception( "removeChild #16", DOMException.NO_DATA_ALLOWED_ERR,
				function(){ the_div.removeChild();} );
  ...
  expect_DOM_exception( "removeChild #18", DOMException.NOT_FOUND_ERR,
				function(){ the_frag.removeChild( the_frag.firstChild.attributes.item(0) ); } );

  expect_DOM_exception( "removeChild #19", DOMException.NOT_FOUND_ERR,
				function(){ the_div.removeChild( the_frag ); } );

  expect_DOM_exception( "removeChild #20", DOMException.NOT_FOUND_ERR,
...
testcase( "isSupported" );
  ...
  x = [ [ "Core",           [ 0, 1 ] ],
	...
	[ "XML",            [ 1, 1 ] ],
	[ "Views",          [ 0, 1 ] ],
	[ "StyleSheets",    [ 0, ("styleSheets" in document) ? 1 : 0 ] ],
	[ "CSS",            [ 0,  ("styleSheets" in document) ? 1 : 0 ] ],
	[ "CSS2",           [ 0, ("styleSheets" in document) ? 1 : 0 ] ],
  ...
  // test of wrong input parameters
  expect_DOM_exception( "isSupported wrong input #1", DOMException.NO_DATA_ALLOWED_ERR,
				function(){the_div.isSupported( "test" ); });
  expect_DOM_exception( "isSupported wrong input #2", DOMException.NO_DATA_ALLOWED_ERR,
				function(){the_div.isSupported();});
...
testcase( "replaceChild" );
  ...
  test( "replaceChild #3", the_frag.firstChild.localName.toUpperCase(), "SPAN" );
  test( "replaceChild #4", the_clone.firstChild.localName.toUpperCase(), "A" );
  test( "replaceChild #4b", the_clone.childNodes.length, 4 );
  tmp = the_frag.replaceChild( the_clone.firstChild, the_frag.firstChild );
  tdef( "replaceChild #5", tmp );
  test( "replaceChild #6", tmp.localName.toUpperCase(), "SPAN" );
  ...
  test( "replaceChild #11", the_frag.firstChild.localName.toUpperCase(), "A" );
  ...
  test( "replaceChild #15", the_clone.childNodes.item(0).localName.toUpperCase(), "A" );
  test( "replaceChild #16", the_clone.childNodes.item(1).localName.toUpperCase(), "SPAN" );
  test( "replaceChild #17", the_clone.childNodes.item(2).localName.toUpperCase(), "A" );
  ...
  test( "replaceChild #20", tmp.localName.toUpperCase(), "A" );
  ...
  test( "replaceChild #24", the_clone.childNodes.item(0).localName.toUpperCase(), "A" );
  test( "replaceChild #25", the_clone.childNodes.item(1).localName.toUpperCase(), "SPAN" );
  test( "replaceChild #26", the_clone.childNodes.item(2).localName.toUpperCase(), "A" );
  test( "replaceChild #27", the_clone.firstChild.hasChildNodes(), false );

  test( "replaceChild #28", the_link.hasChildNodes(), false );
  expect_DOM_exception( "replaceChild #28.5", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ tmp = the_link.replaceChild( the_span.childNodes.firstChild, the_span ); });
  ...
  // null tests
  expect_DOM_exception( "replaceChild #34", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ tmp = the_clone.replaceChild( the_span, null );});
  expect_DOM_exception( "replaceChild #35", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ tmp = the_clone.replaceChild( null, the_clone.firstChild );});
  expect_DOM_exception( "replaceChild #36", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ tmp = the_clone.replaceChild( the_frag, null );});
  expect_DOM_exception( "replaceChild #37", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ tmp = the_frag.replaceChild( the_frag, null );});
  expect_DOM_exception( "replaceChild #38", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ tmp = the_frag.replaceChild( null, null );});


  // test of wrong input parameters
  expect_DOM_exception( "replaceChild #39", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ the_div.replaceChild();});
  expect_DOM_exception( "replaceChild #40", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ the_div.replaceChild( the_clone );});
  expect_DOM_exception( "replaceChild #41", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ the_div.replaceChild( 1, "test" );});
  expect_DOM_exception( "replaceChild #42", DOMException.NO_DATA_ALLOWED_ERR,
	                  function(){ the_div.replaceChild( "test", 1 );});
  ...
  test( "replaceChild #43", divelm.firstChild.nodeValue, "Replaced" );

  // exception tests
  expect_DOM_exception( "replaceChild #44", undefined,
	                  function(){ the_frag.firstChild.replaceChild( the_div.firstChild, the_frag.firstChild ); } );

  expect_DOM_exception( "replaceChild #45", DOMException.HIERARCHY_REQUEST_ERR,
	                  function(){ the_div.firstChild.replaceChild( the_div, the_div.lastChild ); } );

  expect_DOM_exception( "replaceChild #46", DOMException.NOT_FOUND_ERR,
...
testcase( "normalize" );
  ...
  for ( var i=0 ; i < 5 ; i++ )
  {
	...
	test( "normalize #" + (i*2+17), the_frag.childNodes.item(i+1).nodeValue, "A span!" );
  }
...
//  {
	...
	/* 3 tests below disabled, as support for Element.document is removed as part of bug CORE-32020					
  ...
  var nsuri_win = document.getElementById('xmliframe').contentWindow; // window.open('xmldoc.xml', 'node-xml');
  ...
  else
  {
    ...
    function runTests()
    {
      ...
      if (!d || ! (d.getElementById/* &&d.getElementById('taggen3') */))
        if (++attempts > 10)
      ...
      else
      {
        ...
        test( "namespaceURI #2", xmldiv.namespaceURI, 'http://www.w3.org/1999/xhtml');
        ...
        test( "namespaceURI #7", xmlattr2.namespaceURI, 'http://www.w3.org/1999/xhtml');
