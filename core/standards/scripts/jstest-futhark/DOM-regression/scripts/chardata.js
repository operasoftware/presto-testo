...
try {
   ...
   */
   ...
   /* nothing appended */
     expect_DOM_exception( "Attr #19", DOMException.NO_DATA_ALLOWED_ERR,
     function(){   foo.appendData();} );
   ...
   /* insufficient parameters */
     expect_DOM_exception( "Attr #19", DOMException.NO_DATA_ALLOWED_ERR,
     function(){     var z = document.createTextNode( x.substringData( 0 ) );} );

//   test( "substringData #4", z.data, "undefined" );

   /* index out of bounds */
   expect_DOM_exception( "substringData #5", DOMException.NOT_SUPPORTED_ERR,
