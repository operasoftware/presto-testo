...
var cvs = "$Id: statements.js 43149 2009-03-13 17:38:07Z hallvord $";

testmodule( "statements", cvs );
      expect(32);//number of tests - update this when tests are added!
/*
...
var counter=1;
for ( i in theMenu ){
	test( "Bug #63432 regression #"+counter, typeof i, "string" );
	counter++;
}
