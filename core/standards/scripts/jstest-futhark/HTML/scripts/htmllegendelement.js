...
var cvs = "$Id: htmllegendelement.js 108182 2012-01-13 12:09:02Z sigbjornf $";
...
try {
	...
	// After removal, a new attribute will occur with the default value
    	...
    	test ("align", newlegend.getAttribute("align"), null);
    	test ("accessKey", newlegend.getAttribute("accessKey"), null);
