...
var cvs = "$Id: htmltablecellelement.js 108182 2012-01-13 12:09:02Z sigbjornf $";
...
try {
  ...
  test("align",cell.align,"");// default value no longer expected, see bug 291905
  test("axis",cell.axis,"");
  ...
  test("vAlign",cell.vAlign,"");// default value no longer expected, see bug 291905
  test("width",cell.width,"");
  test("abbr",cell.abbr,"");
  var ch = "";// default value no longer expected, see bug 291905
  if(row.lang == "fr") ch = ",";
  test("ch",row.ch,ch);
  ...
  cell.bgColor="#00f00f";
  test("bgColor #2",cell.bgColor,"#00f00f");
  cell.vAlign="bottom";
  ...
  expect_readonly_exception( "cellIndex", function(){"use strict"; cell.cellIndex = 7;} )
