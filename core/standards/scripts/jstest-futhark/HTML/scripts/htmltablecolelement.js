...
var cvs = "$Id: htmltablecolelement.js 22607 2008-01-25 14:48:14Z hallvord $";
...
try {
  ...
  test("align",col.align,'');// default value no longer expected, see bug 291905
  if(is_phase(2))
  {
    var ch = undefined;
    if(col.lang == "fr") ch = ",";
  ...
  test("vAlign",col.vAlign,"");// default value no longer expected, see bug 291905
