...
var cvs = "$Id: htmltextareaelement.js 108182 2012-01-13 12:09:02Z sigbjornf $";
...
try {
  ...
  expect_readonly_exception( "form", function(){"use strict"; inp.form = null;} )
  test("form",inp.form,form);
  var t = inp.type; expect_readonly_exception( "type", function(){"use strict"; inp.type = "illegal";} )
