...
var cvs = "$Id: htmltableelement.js 108182 2012-01-13 12:09:02Z sigbjornf $";
...
//  test("align",tab.align,"center");
  ...
  var rows = tab.rows;
  expect_readonly_exception( "rows", function(){"use strict"; tab.rows = null;} )
  test("rows",tab.rows,rows);
  var tB = tab.tBodies;
  expect_readonly_exception( "tBodies", function(){"use strict"; tab.tBodies = null;} )
