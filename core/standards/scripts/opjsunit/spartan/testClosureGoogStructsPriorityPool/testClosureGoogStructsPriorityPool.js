...
function testExceedMax1() {
  ...
  assertEquals(3, getCount1);
  assertEquals(0, getCount2);
}
...
function testReleaseAndGet3() {
  ...
  assertEquals(0, p.getFreeCount());
  assertTrue(p.releaseObject(o1));
  assertTrue(p.releaseObject(o2));
  assertFalse(p.releaseObject(o4));
  assertEquals(3, p.getCount());
  assertEquals(1, p.getInUseCount());
