...
var $$protocol_and_host = "file://localhost";
var $$base              = "/D:/Source/jstest/";              // test suite directory
var $$mode              = "STANDALONE";                      // or "ART". or PRETTYPRINT
...
if( typeof window!='undefined' && window.location && location.search.match(/mode=(\w*)/) ){ $$mode=RegExp.$1; }
