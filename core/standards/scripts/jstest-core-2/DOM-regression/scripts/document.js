...
var cvs = "$Id: document.js 4838 2006-01-18 05:59:01Z hallvord $";
...
try {
   ...
   expect_DOM_exception_failure('Create element with invalid character in name', -1, DOMException.INVALID_CHARACTER_ERR,
                        function(){document.createElement('<>');}, 'Expected to fail - We have decided not to check for invalid characters in our implementation.' );
