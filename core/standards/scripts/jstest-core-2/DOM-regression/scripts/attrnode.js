...
var cvs = "$Id: attrnode.js 4838 2006-01-18 05:59:01Z hallvord $";
...
try {
   ...
   {
      tdef("Attributes name property", linkfoo[i].name);
      tdef("Attributes value property", linkfoo[i].value);  	
      tdef("Attributes ownerElement property", linkfoo[i].ownerElement);
      tdef("Attributes specified property", linkfoo[i].specified);
   }
   ...
   test( 'set value#1', x.value, "flabbergasted" );
   try {
