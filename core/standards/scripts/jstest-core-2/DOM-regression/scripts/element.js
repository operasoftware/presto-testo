...
var cvs = "$Id: element.js 4838 2006-01-18 05:59:01Z hallvord $";
...
testcase("getAttribute");
  ...
  test("getAttribute #3", body_elm.getAttribute('jalla'), "");
...
testcase("removeAttribute");
  ...
  test("removeAttribute #3", body_elm.getAttribute('bgcolor'), "");
  test("removeAttribute #4", body_elm.getAttribute('jalla'), "");
...
testcase("setAttributeNode");
  ...
  var testwin = window.open('elmpopup.html', 'testwin');
  if (!testwin)
...
testcase("removeAttributeNode");
  ...
  test("removeAttributeNode #3", body_elm.getAttribute('bgcolor'), "");
  test("removeAttributeNode #4", body_elm.getAttribute('jalla'), "");
...
testcase("hasAttribute");
  ...
  var xmlwin = window.open('xmldoc.xml', 'element-xml');
  if (!xmlwin)
  {
    showfailure( "Opening secondary window", "Opening window failed." );
    testmodule_finished();
  ...
  else
  {
    ...
    function runTests()
    {
      ...
      else
      {
        ...
        xmltag = xmlwin.document.getElementById('taggen1');
        xmltag2 = xmlwin.document.getElementById('taggen2');
        xmltag3 = xmlwin.document.getElementById('taggen3');
