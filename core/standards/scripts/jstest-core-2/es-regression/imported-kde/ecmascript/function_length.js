...
shouldBe("Array.prototype.slice.length","0");
shouldBe("Array.prototype.sort.length","1");
shouldBe("Array.prototype.splice.length","1");
...
shouldBe("String.prototype.indexOf.length","2");
shouldBe("String.prototype.lastIndexOf.length","2");
...
shouldBe("String.prototype.slice.length","0");
shouldBe("String.prototype.split.length","1");
