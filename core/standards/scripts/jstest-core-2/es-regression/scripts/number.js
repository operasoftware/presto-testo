...
var cvs = "$Id: number.js 4838 2006-01-18 05:59:01Z hallvord $";
...
testcase( "Number.prototype.toString()" );
 ...
 if (isExplorer())
   expect_exception( "#14 toString", TypeError, 
...
testcase( "toFixed" );
  ...
  test( "toFixed #9", (1e21).toFixed(1), (1e21).toString() );
  test( "toFixed #9", (-1e21).toFixed(1), (-1e21).toString() );
...
testcase( "toExponential" );
  ...
  test( "toExponential #10", (31.4159).toExponential(4), "3.1416e+1" );
  test( "toExponential #10", (31.4165).toExponential(4), "3.1416e+1" );  // Round to even
  ...
  test( "toExponential #16", (0.05050505).toExponential(Number.NEGATIVE_INFINITY), "5e-2" );  // Infty -> 0
...
testcase( "toPrecision" );
  ...
  test( "toPrecision #17", (0.12345).toPrecision(4), "0.1235", "#184756");
  test( "toPrecision #17", (-0.12345).toPrecision(4), "-0.1235", "#184756");
  }
