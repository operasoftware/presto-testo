...
var cvs = "$Id: operators.js 33816 2008-10-01 21:35:15Z hallvord $";
...
try {
	...
	testcase( "lvalue errors are now reference-errors" );
	...
	expect_exception( "lvalue #2", ReferenceError, function(){ eval( "'foo' += 'bar';" ); } );
