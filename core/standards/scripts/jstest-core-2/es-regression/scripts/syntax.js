...
var cvs = "$Id: syntax.js 4838 2006-01-18 05:59:01Z hallvord $";
...
test( 'insertion before preincrement', res, 1 );
test( 'insertion before preincrement', f, 1 );
...
try {
  ...
  test( "OK syntax error #1", e.message.indexOf("in call to eval") > 0, true );
...
try {
  ...
  test( "OK syntax error #3", e.message.indexOf("Reference required") > 0, true, e.message );
  test( "OK syntax error #4", e.message.indexOf("line 2") > 0, true, e.message, 88700 );
}
...
try {
  ...
  test( "OK syntax error #5", e.message.indexOf("in function body") > 0, true, e.message );
}
