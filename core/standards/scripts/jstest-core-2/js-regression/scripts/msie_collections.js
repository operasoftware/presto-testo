...
var cvs = "$Id: msie_collections.js 4838 2006-01-18 05:59:01Z hallvord $";
...
try {
	...
	test( "forms #13", document.forms.item("form2").id, "form2" );
    }
	...
	test( "radio #3", document.forms[1].item("r1").length, 5 );
    }
