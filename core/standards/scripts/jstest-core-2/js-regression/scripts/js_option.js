...
function testOptionConstructor( optionObject )
{
   ...
   test( "adding a new option object to Select.options", optionsArray.length, ( oldLength + 1 ), "82214" );
   test_s( 'adding a new option object to Select.options',  optionsArray[ optionsArray.length - 1 ], optionObject );
}
