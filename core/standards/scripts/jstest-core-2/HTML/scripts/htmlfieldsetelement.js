...
var cvs = "$Id: htmlfieldsetelement.js 4838 2006-01-18 05:59:01Z hallvord $";
...
try {
	...
	expect_DOM_exception( "form", DOMException.NO_MODIFICATION_ALLOWED_ERR, function(){f2.form = document.forms[1];} )
    test ("form", l2.form, document.forms[0]);
	expect_DOM_exception( "form", DOMException.NO_MODIFICATION_ALLOWED_ERR, function(){f2.form = document.forms[1];} )
    test ("form", l2.form, document.forms[0]);
