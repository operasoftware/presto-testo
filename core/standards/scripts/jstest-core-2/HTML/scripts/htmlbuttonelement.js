...
var cvs = "$Id: htmlbuttonelement.js 4838 2006-01-18 05:59:01Z hallvord $";
...
try {
    ...
    expect_DOM_exception( "form", DOMException.NO_MODIFICATION_ALLOWED_ERR, function(){b2.form = document.forms[1];})
    test ("form", b2.form, document.forms[0]);

    expect_DOM_exception( "type", DOMException.NO_MODIFICATION_ALLOWED_ERR, function(){b2.type = "textarea";})
    test ("type", b2.type, "button");
	...
	test ("disabled", newb1.hasAttribute("disabled"), true);
	test ("name", newb1.hasAttribute("name"), true);
	test ("tabIndex", newb1.hasAttribute("tabIndex"), true);
	test ("type", newb1.hasAttribute("type"), true);
	test ("value", newb1.hasAttribute("value"), true);
        ...
        test ("type", newb2.hasAttribute("type"), true);
    ...
    test ("accessKey", newb1.getAttribute("accessKey"), "");
    test ("disabled", newb1.getAttribute("disabled"), "");
    test ("name", newb1.getAttribute("name"), "");
    test ("tabIndex", newb1.getAttribute("tabIndex"), "");
    test ("type", newb1.getAttribute("type"), "submit");
    test ("value", newb1.getAttribute("value"), "");
   ...
   test ("form", newb2.getAttribute("form"), "");
   test ("accessKey", newb2.getAttribute("accessKey"), "");
   test ("disabled", newb2.getAttribute("disabled"), "");
   test ("name", newb2.getAttribute("name"), "");
   test ("tabIndex", newb2.getAttribute("tabIndex"), "");
   test ("type", newb2.getAttribute("type"), "submit");
   test ("value", newb2.getAttribute("value"), "");
