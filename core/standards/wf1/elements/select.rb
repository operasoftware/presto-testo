...
describe "select" do
  ...
  it "multiple option, variation" do
    ...
    browser.text.should == "You typed: [foobar1] [foobar6]"
  end
  ...
  it "Multiple unique inputs" do
    ...
    browser.button(:name, "submit").click
    browser.text.should == "You typed: [foo] [bar]"
  end
  ...
  it "Value of disabled field available in DOM" do
    ...
    browser.p(:name, "result").text.should include("foobar")
  end
  ...
  it "multiple option" do
    ...
    browser.keys.send :Space
    browser.button(:name, "submit").click
    browser.text.should == "You typed: [foobar1] [foobar2]"
  end
