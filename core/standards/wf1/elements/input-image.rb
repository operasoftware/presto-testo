...
describe "input type=image" do
  ...
  it "Click image button, with image" do
    ...
    browser.button(:id, "test").visual_hash.should == browser.image(:id, "reference").visual_hash
  ...
  it "Click image button, without image" do
    ...
    browser.button(:id, "test").visual_hash.should == browser.element(:id, "reference").visual_hash
    browser.button(:id, "test").click
    browser.text.should include("Result: PASS")
  end
