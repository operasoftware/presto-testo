...
testsuite = {
    ...
    #preload="auto"
    'semantics/preload/auto/preload-auto-event-order.tpl' : [
    ...
    'semantics/preload/auto/preload-auto-to-none-event-order.tpl' : [
    ...
    'semantics/preload/auto/preload-auto-to-metadata-event-order.tpl' : [
    ...
    #preload="metadata"
    'semantics/preload/metadata/preload-metadata-event-order.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-event-order-play-after-suspend.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-networkstate-after-suspend.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-readystate-after-suspend.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-buffered.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-to-auto-event-order.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-to-none-event-order.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-to-none-after-src-networkstate.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-to-none-after-src-readystate.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-to-none-after-source-readystate.tpl' : [
        {'test_suffix' : 'dataurl', 'test_mapping' : {'media_type' : 'wave', 'media_src' : dataurl_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout_dataurl}},
        {'test_suffix' : 'mp4', 'test_mapping' : {'media_type' : 'mp4', 'media_src' : mp4_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}},
        {'test_suffix' : 'ogg', 'test_mapping' : {'media_type' : 'ogg', 'media_src' : ogg_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}},
        {'test_suffix' : 'webm', 'test_mapping' : {'media_type' : 'webm', 'media_src' : webm_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}}
        ],
    'semantics/preload/metadata/preload-metadata-to-none-before-src-readystate.tpl' : [
        {'test_suffix' : 'dataurl', 'test_mapping' : {'media_type' : 'wave', 'media_src' : dataurl_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout_dataurl}},
        {'test_suffix' : 'mp4', 'test_mapping' : {'media_type' : 'mp4', 'media_src' : mp4_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}},
        {'test_suffix' : 'ogg', 'test_mapping' : {'media_type' : 'ogg', 'media_src' : ogg_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}},
        {'test_suffix' : 'webm', 'test_mapping' : {'media_type' : 'webm', 'media_src' : webm_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}}
        ],
    'semantics/preload/metadata/preload-metadata-to-none-before-source-readystate.tpl' : [
        {'test_suffix' : 'dataurl', 'test_mapping' : {'media_type' : 'wave', 'media_src' : dataurl_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout_dataurl}},
        {'test_suffix' : 'mp4', 'test_mapping' : {'media_type' : 'mp4', 'media_src' : mp4_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}},
        {'test_suffix' : 'ogg', 'test_mapping' : {'media_type' : 'ogg', 'media_src' : ogg_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}},
        {'test_suffix' : 'webm', 'test_mapping' : {'media_type' : 'webm', 'media_src' : webm_src, 'state_expected' : metadata_readystate_before_src, 'start_state' : 'metadata', 'end_state' : 'none', 'end_event' : 'suspend', 'test_state_type' : 'readyState', 'timeout' : timeout}}
        ],
    'semantics/preload/metadata/preload-metadata-to-none-after-loadstart-networkstate.tpl' : [
    ...
    'semantics/preload/metadata/preload-metadata-to-none-after-loadstart-readystate.tpl' : [
    ...
    #preload="none"
    'semantics/preload/none/preload-none-event-order.tpl' : [
    ...
    'semantics/preload/none/preload-none-event-order-autoplay.tpl' : [
    ...
    'semantics/preload/none/preload-none-event-order-autoplay-after-suspend.tpl' : [
    ...
    'semantics/preload/none/preload-none-event-order-play-after-suspend.tpl' : [
        {'test_suffix' : 'dataurl', 'test_mapping' : {'media_type' : 'wave', 'media_src' : dataurl_src, 'events_expected' : none_event_order_play_after_suspend_dataurl, 'start_state' : 'none', 'start_event' : 'suspend', 'end_event' : 'canplaythrough', 'timeout' : timeout_dataurl}},
        {'test_suffix' : 'mp4', 'test_mapping' : {'media_type' : 'mp4', 'media_src' : mp4_src, 'events_expected' : none_event_order_play_after_suspend, 'start_state' : 'none', 'start_event' : 'suspend', 'end_event' : 'canplaythrough', 'timeout' : timeout}},
        {'test_suffix' : 'ogg', 'test_mapping' : {'media_type' : 'ogg', 'media_src' : ogg_src, 'events_expected' : none_event_order_play_after_suspend, 'start_state' : 'none', 'start_event' : 'suspend', 'end_event' : 'canplaythrough', 'timeout' : timeout}},
        {'test_suffix' : 'webm', 'test_mapping' : {'media_type' : 'webm', 'media_src' : webm_src, 'events_expected' : none_event_order_play_after_suspend, 'start_state' : 'none', 'start_event' : 'suspend', 'end_event' : 'canplaythrough', 'timeout' : timeout}}
        ],
    'semantics/preload/none/preload-none-to-auto-event-order.tpl' : [
    ...
    'semantics/preload/none/preload-none-to-invalid-event-order.tpl' : [
    ...
    'semantics/preload/none/preload-none-to-metadata-event-order.tpl' : [
    ...
    'semantics/preload/none/preload-none-remove-attribute-event-order.tpl' : [
