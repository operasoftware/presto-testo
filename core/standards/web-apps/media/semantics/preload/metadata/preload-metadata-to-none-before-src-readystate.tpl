<!doctype html>
<title>HTMLMediaElement.preload:$start_state $test_state_type when preload is set to $end_state before src is set - $media_type</title>
...
<script>
var tests = init_tests("HTMLAudioElement.preload:$start_state $test_state_type when preload is set to $end_state before src is set - $media_type", "HTMLVideoElement.preload:$start_state $test_state_type when preload is set to $end_state before src is set - $media_type");
