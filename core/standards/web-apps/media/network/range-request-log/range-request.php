 ...
 *
 * fileloc=FILE : The {rel|abs}path to file to send (Default = ../../../../../../resources/media/xiph/theora_testsuite/320x240.ogg)
...
if (isset($_GET['fileloc']))
  ...
  $filelocation = '../../../../../../resources/media/xiph/theora_testsuite/320x240.ogg'; //used a lot in video tests, leaving it as is
if (isset($_GET['rate']))
