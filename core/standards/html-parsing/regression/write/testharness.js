...
(function ()
{
  ...
  function test(func, name, properties)
    ...
    */
    ...
    {
        var print_arrays = ("length" in actual && actual.length < 10 &&
                            "length" in expected && expected.length < 10);

        if (print_arrays)
        {
            var message = make_message("assert_array_equals", description,
            "arrays differ, expected [${expected}] got [${actual}]",
