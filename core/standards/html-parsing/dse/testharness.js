...
(function ()
{
  ...
  function test(func, name, properties)
    ...
    */
    ...
    expose(add_start_callback, 'harness.add_start_callback');
    expose(add_result_callback, 'harness.add_result_callback');
    expose(add_completion_callback, 'harness.add_completion_callback');
